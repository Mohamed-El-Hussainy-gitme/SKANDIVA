...
write("src/app/kassa/page.tsx", """\"use client\";
...
export default function KassaPage() {
  ...
  const handleSubmitOrder = async (e: React.FormEvent) => {
    ...
    const orderNumber = `SKD-${new Date().getFullYear()}-${Math.floor(1000 + Math.random() * 9000)}`;
    ...
    const initialEvents: TrackingEvent[] = [
      {
        ...
        description: `Beställningen är mottagen i Skandiva verkstadssystem. Betalning registrerad via ${paymentMethod.toUpperCase()}.`,
      ...
      },
      {
        ...
        title: "Material & Tyg Förbereds",
        description: "Mönsterpassning, tyg/fårskinn och stomdetaljer plockas fram i ateljén.",
        timestamp: "Planerad inom 24–48 timmar",
        completed: false,
        active: true,
      },
      {
        ...
        description: "Möbeltapetserare utför arbetet enligt specifikation.",
        timestamp: "Beräknas starta inom kort",
        completed: false,
        active: false,
      },
      {
        ...
        title: "Kvalitetskontroll & Sigill",
        description: "Mästargranskning av sömmar och stämpel monteras.",
        timestamp: "Före utskick",
        completed: false,
        active: false,
      },
      {
        ...
        title: "Redo för Leverans / Upphämtning",
        description: `Möbeln levereras till ${customerAddress}, ${customerCity}.`,
        timestamp: "Slutleverans",
        completed: false,
        active: false,
      },
    ];
    ...
    const newOrder: Order = {
      ...
      orderNumber,
      orderType: items.some((i) => i.type === "service") ? "service" : "product",
      customerName,
      customerEmail,
      customerPhone,
      customerAddress,
      ...
      workshopNotes: workshopNotes || "Order mottagen via e-handel. Standard hantering.",
    ...
    router.push(`/kassa/tack?order=${orderNumber}`);
  };
