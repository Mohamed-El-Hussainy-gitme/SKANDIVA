...
export const metadata: Metadata = {
  title: "Verkstadstjänster & Möbelrestaurering — Skandiva Stockholm",
  description:
    "Professionella tapetserartjänster i Stockholm. Helomklädsel av Lamino med fast pris, Bruno Mathsson fåtöljer, soffor och B2B cirkulär renovering.",
};

export default async function TjansterPage() {
  let services: WorkshopService[] = [];
  try {
    services = await serverDb.getServices();
  } catch (e) {
    console.error("Failed to load services for /tjanster", e);
  }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
      ...
      <div className="space-y-8">
        <h3 className="font-serif text-2xl sm:text-3xl text-ink font-normal border-b border-stone pb-4">
          Alla Verkstadstjänster ({services.length} st)
        </h3>
